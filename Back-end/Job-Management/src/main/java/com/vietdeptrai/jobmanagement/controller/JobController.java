...
public class JobController {
		...
		// Search Jobs
		@RequestMapping(value = "/SearchJobs/{key}", method = RequestMethod.GET)
		public List<Job> SearchJobs(@PathVariable(value = "key") String key) {
			try 
			{
				return repositoryJob.searchJobByName(key);
			} 
			catch (Exception e) {
